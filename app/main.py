...
from app.routers import import_router, query_router, risk_router, enrich_router, report_router
import logging
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        with engine.connect() as conn:
            logger.info(f"Successfully connected to database at {settings.DATABASE_URL.split('@')[-1]}")
